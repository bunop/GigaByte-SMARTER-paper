...
Endpoint parameters documentation is detailed using Swagger and can be accessed via the \texttt{/docs} location of the SMARTER-backend itself. Table 3 provides a list of the available endpoints.
...
We plan to support more assemblies with the possibility to collect data in VCF format: this could help the community to reuse this data and could give the possibility to upload genotypes to public archives like EBI-EVA.
