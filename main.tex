...
The code is available as open source software under the MIT license at https://github.com/cnr-ibba/SMARTER-database. The database is accessible at https://webserver.ibba.cnr.it/smarter/
\end{abstract}

\begin{keywords}
Genetics and Genomics; Bioinformatics; Animal Genetics; Data Integration
\end{keywords}
\end{frontmatter}
...
\item Writing - review \& editing: Arianna Manunza, Johanna Ramirez-Diaz, Bertrand Servin, Rachel Rupp
